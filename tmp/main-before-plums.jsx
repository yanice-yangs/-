          ...
          <div className="hero-content page-width">
            ...
            <div className="hero-sculpture" aria-hidden="true">
              <svg viewBox="0 0 700 700" fill="none">
                <defs>
                  <linearGradient id="chrome" x1="130" y1="80" x2="570" y2="640" gradientUnits="userSpaceOnUse"><stop stopColor="#111015"/><stop offset=".17" stopColor="#f5f3f7"/><stop offset=".24" stopColor="#48464e"/><stop offset=".4" stopColor="#070609"/><stop offset=".53" stopColor="#a29ca9"/><stop offset=".58" stopColor="#f5eaff"/><stop offset=".63" stopColor="#201627"/><stop offset=".83" stopColor="#050406"/><stop offset="1" stopColor="#a079bc"/></linearGradient>
                  <linearGradient id="facet" x1="250" y1="130" x2="510" y2="570" gradientUnits="userSpaceOnUse"><stop stopColor="#bbb7bf"/><stop offset=".3" stopColor="#3c3942"/><stop offset=".7" stopColor="#121017"/><stop offset="1" stopColor="#766f7e"/></linearGradient>
                  <linearGradient id="edge" x1="200" y1="100" x2="540" y2="620" gradientUnits="userSpaceOnUse"><stop stopColor="#fafafa"/><stop offset=".4" stopColor="#8d21ff"/><stop offset=".6" stopColor="#d4a4ff"/><stop offset="1" stopColor="#14081e"/></linearGradient>
                  <filter id="glow"><feGaussianBlur stdDeviation="7"/></filter>
                </defs>
                <g transform="rotate(-17 350 350)">
                  <path d="M355 89 584 327 421 611 151 427 195 189Z" fill="url(#chrome)" stroke="#55505c" strokeWidth="2"/>
                  <path d="m355 89 49 195 180 43-163 284-36-216-234 32 44-238Z" fill="url(#facet)"/>
                  <path d="m355 89 49 195 180 43M404 284l-19 111 36 216M385 395l-234 32" stroke="url(#edge)" strokeWidth="2"/>
                  <path d="m230 222 52 14-37 153-45 10Z" fill="#08060c" stroke="#65526f"/>
                  <path d="m257 252-29 110 39-27 15-78" stroke="#b147ff" strokeWidth="9" filter="url(#glow)"/>
                  <path d="m257 252-29 110 39-27 15-78" stroke="#d9b4ff" strokeWidth="2"/>
                  <path d="m431 319 85 30-64 109-31-45Z" fill="#13071e" stroke="#8c51b1"/>
                  <path d="m445 347 42 13-34 66-14-22Z" stroke="#b240ff" strokeWidth="9" filter="url(#glow)"/>
                  <path d="m445 347 42 13-34 66-14-22Z" stroke="#dab4ff" strokeWidth="2"/>
                  <path d="M250 166C204 55 395 3 418 137c11 67-26 111-53 95" stroke="#07070a" strokeWidth="43" strokeLinecap="round"/>
                  <path d="M250 166C204 55 395 3 418 137c11 67-26 111-53 95" stroke="url(#chrome)" strokeWidth="34" strokeLinecap="round"/>
                  <path d="M241 145C215 60 356 23 392 91" stroke="#f4eff8" strokeOpacity=".75" strokeWidth="3" strokeLinecap="round"/>
                  <path d="m163 438 250 184 166-278" stroke="url(#chrome)" strokeWidth="7"/>
                </g>
              </svg>
